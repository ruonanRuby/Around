...
func handlerSearch(w http.ResponseWriter, r *http.Request) {
	...
	if err != nil {
		...
		fmt.Printf("Failed to read post from Elasticsearch from search call %v.\n", err)
		return
	}
...
func handlerCluster(w http.ResponseWriter, r *http.Request) {
	...
	searchResult, err := readFromES(query, POST_INDEX)
	if err != nil {
		http.Error(w, "cluster Failed to read from Elasticsearch", http.StatusInternalServerError)
		return
	}
